...
from apps.orders.views import OrderCreateView, MpWebhookView, OrderView, MpPaymentView, OrderListAPIView, OrderUpdateAddressView
...
urlpatterns = [
    ...
    path('order-address/', OrderUpdateAddressView.as_view(), name='order-address'),
]
