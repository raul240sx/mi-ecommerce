...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, email, password, **extra_fields):
        ...
        if extra_fields.get('is_verified') is not True:
            raise ValueError('Superusuario debe tener is_verified=True.')
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    phone = models.CharField('Número celular',max_length=9, blank=True, null=True, unique=True)

    # El usuario verificó su email
    ...
    def is_profile_complete(self):
        ...
        response = True if has_name and has_phone and has_address else False
        return response
